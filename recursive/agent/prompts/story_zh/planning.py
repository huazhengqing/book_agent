...
20. 全书结构规划: 整合全书所有设计，划分为若干“卷”，并为每个单元分配其需承载的：情节主线、核心冲突、角色弧光、世界观进展、情绪节奏、以及字数与结尾钩子。(必需) (依赖: 1-19)
...
14. 本卷结构规划: 整合本卷所有设计，划分为若干“幕”，并为每个单元分配其需承载的：核心事件链、角色成长节点、世界观揭示内容、核心爽点、情绪高潮、以及悬念伏笔与幕末钩子。(必需) (依赖: 1-13)
...
15. 本幕结构规划: 整合本幕所有设计，划分为若干“章”，并为每个单元分配其需承载的：核心事件、角色关键转变、情绪交付、信息披露、以及情节功用与章末钩子。(必需) (依赖: 1-14)
...
10. 本章结构规划: 整合本章所有设计，将核心事件分解为若干“场景”，并为每个单元分配其需承载的：功能定位、核心冲突、角色行动、高光时刻、情绪节点、以及关键进展与场景衔接。(必需) (依赖: 1-9)
...
10. 本场景结构规划: 整合本场景所有设计，将事件流程分解为若干“节拍”，并为每个单元分配其需承载的：微观目标、核心互动、角色状态转变、关键信息揭示、以及动力衔接。(必需) (依赖: 1-9)
...
8. 本节拍结构规划: 整合本节拍所有设计，将“动作-反应”单元分解为若干“段落”，并为每个单元分配其需承载的：核心功能（动作/对话/心理/描写）、关键信息、以及行文节奏与段落衔接。(必需) (依赖: 1-7)
