...
4. 深层结构设计：原型模式选择（英雄之旅/悲剧/喜剧）、象征体系构建、主题层次架构、二元对立设计、神话原型运用、集体无意识元素 （可选）（依赖1-3）
...
8. 世界观构建：世界规则、设定体系、势力分布、权力结构、历史背景、文化体系、经济体系 （玄幻/科幻）（依赖4-7）
...
12. 悬念系统：多线悬念、信息控制、反转设计、谜团层次、伏笔布局、红鲱鱼设计 （悬疑）（依赖8-10）
13. 金手指体系：能力获得、升级体系、规则限制、成长可视化、平衡机制、代价设计 （爽文）（依赖8-10）
14. 情感线设计：CP设定、感情发展、虐恋节奏、甜宠平衡、情感冲突、情感成长弧、情感层次递进 （言情）（依赖11-13）
15. 全书节奏：整体节奏规划、高潮频率、张弛节奏、情绪波动曲线、节拍控制、呼吸感设计、节奏变化规律 （必需）（依赖11-13）
16. 开局设计：强开局策略、3秒吸引、黄金三章、1000字内入冲突、钩子设计、代入感建立、开局类型选择 （爆款）（依赖11-13）
17. 中局维持：中局不拖沓、情节推进力、兴趣点维持、节奏控制、悬念递进、读者粘性保持 （爆款）（依赖11-13）
18. 结局设计：结局类型选择、情感满足度、逻辑完整性、余韵营造、系列化考虑、读者期待满足 （必需）（依赖11-13）
19. 读者体验设计：期待视野管理、沉浸体验营造、认知负荷控制、参与感激发、代入感强化、情感共鸣点 （可选）（依赖14-18）
20. 爽点与情绪操控：核心爽点类型、情绪满足点布局、共鸣点挖掘、情感共振、代入感强化、情绪释放节点 （爆款）（依赖14-18）
21. 成瘾与传播机制：悬念钩子、奖励机制、期待管理、话题制造、名场面规划、社交传播点、病毒式传播设计 （爆款）（依赖14-18）
22. 叙事风格：文笔特色、对话风格、语言节奏、修辞手法、文体选择、语言个性化 （必需）（依赖19-21）
23. 文化内核：价值观输出、社会议题、时代精神、文化自信、现实关照、深度思考 （可选）（依赖19-21）
24. 商业运营：付费转换点、VIP章节规划、订阅挽留策略、互动设计、更新策略、数据优化、用户留存机制 （爆款）（依赖19-21）
