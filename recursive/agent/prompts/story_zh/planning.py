...
审查  `planning.py` 中的 分层设计指导 中的    ## 全书级别     的  设计要点 中的 所有要素，提出改进建议，有没有缺少什么重要的要素。
要求：清晰、精确、易于理解，在保持质量的同时，尽可能简洁，不要有各种“黑话”和比喻，最好以关键词为主

审查  `planning.py` 中的 分层设计指导 中的    ## 卷级别     的  设计要点，并就如何在宏大故事框架内构建完整且有冲击力的独立篇章提出改进建议。
要求：清晰、精确、易于理解，在保持质量的同时，尽可能简洁，不要有各种“黑话”和比喻，最好以关键词为主
...
## 全书级别
1. 市场定位: 确定核心题材、目标读者（男频/女频）、对标作品分析、核心卖点、差异化创新点。(必需)
2. 核心概念: 确定一句话故事、贯穿全书的核心吸引点、核心情感体验（如爽/燃/甜）、世界观钩子、主角魅力、核心设定/规则（含金手指）、核心悬念。(必需) (依赖: 1)
3. 书名与简介: 产出多个备选书名、长短版简介、核心关键词与标签。(必需) (依赖: 1, 2)
4. 主题内核: 确定故事主题、核心价值观、普世情感、情感基调、主角成长弧光。(必需) (依赖: 2)
5. 世界观: 确定世界基础规则（物理/社会）、核心体系（力量/技术/魔法/经济等）、社会结构、主要势力、关键历史与地理、文化风俗、世界观核心矛盾。(必需) (依赖: 2, 4)
6. 主角设计: 确定主角背景、核心驱动力（欲望/恐惧）、长短期目标、性格特质与内在矛盾、待入感与反差感、核心能力（含金手指的设定、成长性与限制）、主角成长路径、关键弱点与代价。(必需) (依赖: 4, 5)
7. 角色生态: 确定核心反派（目标/动机/能力/与主角的对立关系）、关键配角（功能/阵营/成长弧光）、主角核心关系网（盟友/敌人/情感对象）及其动态演变。(必需) (依赖: 5, 6)
8. 核心冲突: 确定主线冲突（内在/人际/环境）、根源与核心对立面、冲突的升级路径与关键转折点、最终解决方案。(必需) (依赖: 5, 6, 7)
9. 情节架构: 确定全书整体结构、核心主线与关键支线(多层次/明暗交织)、关键情节模式（如升级循环）、重大情节节点（黄金开篇/激励事件/中期转折/高潮/结局）、关键序列/事件链。(必需) (依赖: 7, 8)
10. 情绪节奏: 定义核心读者情感体验。规划全书情绪曲线，设计关键情绪（如爽/虐/燃/悬疑等）的类型、强度、密度、分布节奏与爆发节点。(必需) (依赖: 9)
11. 悬念与伏笔: 设计悬念系统（长/中/短期），规划核心伏笔的埋设、强化、回收机制（用于制造反转与惊喜）。(必需) (依赖: 9)
12. 叙事节奏: 设定信息流（信息密度/披露时机）与事件流（事件密度/推进速度）的宏观节奏。规划重大高潮分布。平衡场景类型（动作/对话/描写等）比例。(必需) (依赖: 9, 10)
13. 叙事风格: 确定叙事视角、叙事时态、语言风格、文笔基调、核心叙事策略（如展示/讲述比例）。(必需) (依赖: 1, 2, 4)
...
## 场景级别
1. 场景目标与冲突: 确定场景功能（情节推进/人物塑造/氛围营造）、核心冲突、参与角色与最终结果，确保服务于本章核心情绪。(必需)
...
5. 节奏与张力: 确定场景内部节奏（快/慢）与张力（建立-升级-释放）的路径，通过信息差制造期待。(必需) (依赖: 4)
