...
- 叙事风格 (写作任务必需): 包含视角设定、语言风格、文笔基调、叙事策略、描写技巧、对话风格、节奏控制等维度。


# 写作任务特殊要求
当任务类型为写作(包含"写"、"续写"、"创作"等关键词)时，必须生成叙事风格相关查询：
- 叙事视角查询: `叙事视角 人称设定 POV`
- 语言风格查询: `语言风格 文笔特色 措辞特点`
- 文笔基调查询: `文笔基调 情感氛围 叙事氛围`
- 叙事策略查询: `叙事策略 展示技巧 描写比例`
- 描写技巧查询: `描写手法 叙事技巧 表现手法`
- 对话风格查询: `对话风格 人物语言 说话特点`
- 节奏控制查询: `叙事节奏 情节节拍 张弛控制`
